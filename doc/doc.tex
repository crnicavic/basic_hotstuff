...
kojeg se replike dogovaraju, kao i redni broj pogleda. Ukoliko poruka dolazi
od vođe poruka nosi sertifikat kvoruma, a ukoliko je od replike poruka nosi
parcijalni potpis. Izuzetak za ovo predstavlja slučaj prelaska u sledeći pogled
kada replika šalje vođi najnoviji sertifikat kvoruma koji poseduje.
...
bloku u lancu izvršenih blokova.

\subsection{Faze algoritma}

Svaki pogled algoritma, tj. razmatranje predloga je podeljeno u faze. Hotstuff
algoritam ima 3 faze, gde svaka ima sličnu strukturu, a to je da vođa predlaže
nešto, replike glasaju ili ostaju suzdržane, formira se sertifikat kvoruma
