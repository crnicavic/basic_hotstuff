...
Drugi sastavni deo pejsmejkera je logika za određivanje vođe u svakom pogledu.
Izbor vođe mora biti determinističan i unapred poznat svim ispravnim replikama.
Najjednostavniji način za postizanje toga je promena vođe u svakom pogledu,
primenom \textit{round robin} strategije. Drugim rečima, u toku $n$ uzastopnih
pogleda, svaka replika će dobiti tačno jedan mandat kao vođa konsenzusa.
...
Pored logike prelaska u sledeći pogled, klasa koja opisuje pejsmejker implementira i
metodu \textit{get\_leader} koja određuje vođu u trenutnom pogledu, u skladu sa
\textit{round robin} strategijom. To se postiže računanjem ostatka deljenja
trenutnog pogleda sa ukupnim brojem replika u sistemu.
