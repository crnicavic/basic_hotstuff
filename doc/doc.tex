...
mrežne komunikacije ispravni vođa sprovede dostizanje saglasnosti replika
razmenom $O(n)$ poruka, gde $n$ označava broj replika u sistemu. Ukoliko dođe do
uzastopnih otkaza vođe, u najgorem slučaju broj poruka može biti $O(n^2)$.
